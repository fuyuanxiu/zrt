    ...
    layui.use(['table', 'laydate'], function(){
        ...
        tableIns=table.render({
            ...
            cols: [[
                ...
                ,{field:'TR_LOTNO', title:'供应商批次', width:'10%', align:'center'}
                ,{field:'DEPOT_NAME', title:'仓库', width:'10%', align:'center'}
                ,{field:'PROD_DATE', title:'生产日期', width:'15%', align:'center'}
                ,{field:'INDEP_DATE', title:'入库日期', width:'15%', align:'center'}
                ,{field:'ITEM_DESCRIPTION', title:'物料名称', width:'10%', align:'center'}
                ,{field:'SUPP_NAME', title:'供应商', width:'10%', align:'center'}
                ,{field:'DAYS', title:'在库时间', width:'8%', align:'center'}
                ,{field:'TO_EXTDATE', title:'到期日期', width:'15%', align:'center'}
